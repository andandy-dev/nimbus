...
function crearArrayProductos() {
    if (serviciosArr.length == 0) {
        serviciosArr.push(new servicios(0, "Mockup", "Basandonos en tus ideas, creamos una vista previa del sitio mediante programas de diseño.", 6500, "wireframe.svg"));
        serviciosArr.push(new servicios(1, "Mockup a HTML", "Si ya dispones de un mockup, convertimos esas ideas en un sitio real.", 9800, "wireframe_to_html.svg"));
...
const animateDom = (id) => {
    $("#containerModalContacto").css({
        'display': 'flex'
    });
    $(id).html('<p>envianos un e-mail a info@nimbus-solutions.com</p><br><br><button id="cerrarModal" class="ctaJquerry">cerrar</button>');
